 ...
 * Fixed ports for all resources - prevents conflicts and loading issues
 ...
 */
export function getPort(resource, type = 'default') {
 ...
 */
export function getBaseURL(resource, type = 'default', host = 'localhost') {
 ...
 */
export function getResourceURL(resource, path = '', type = 'default', host = 'localhost') {
