...
const useResend = resendApiKey.trim() !== '';
...
const systemEmail = process.env.CONTACT_SYSTEM_EMAIL || 'website@paxiit.com';
const recipientEmail = process.env.CONTACT_RECIPIENT_EMAIL || 'contact@paxiit.com';
...
console.log(`[Contact API] Environment: ${isProduction ? 'PRODUCTION' : 'LOCAL DEV (Windows PC)'}`);
console.log(`[Contact API] Email provider: ${useResend ? 'Resend (SMTP)' : 'SMTP (Mail Station / other)'}`);
if (!useResend) {
...
// - Resend via SMTP: smtp.resend.com:465 (implicit TLS)
// - Fallback: your existing SMTP (Mail Station / Roundcube)
...
IP Address: ${req.headers['x-forwarded-for'] || req.connection.remoteAddress || 'Unknown'}
                        ...
                        try {
                            ...
                            const systemSender = systemEmail;
                            ...
                            const cleanReplyTo = (contactData.email || '').trim();
                            
                            const mailOptions = {
                                from: `"Website Contact Form" <${systemSender}>`,
                                to: recipient, // Goes directly to Roundcube inbox
                                replyTo: `"${safeName}" <${cleanReplyTo}>`, // Reply goes back to sender
                                ...
                                html: `
                                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                                        ...
                                        <div style="background-color: #f9f9f9; padding: 15px; border-radius: 5px; margin: 20px 0;">
                                            ...
                                            <p style="margin: 5px 0;"><strong>Email:</strong> <a href="mailto:${safeEmail}" style="color: #4CAF50;">${safeEmail}</a></p>
