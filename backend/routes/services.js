...
const servicesData = [
    ...
    },
    {
        ...
        icon: "🤖",
        category: "ai",
        description: "Practical AI solutions and platform integration. We focus on AI applications, tools, and integrations - not machine learning model development. Transform your business with ready-to-use AI technologies.",
        details: [
        ...
        technologies: ["OpenAI API", "Anthropic Claude", "Google AI", "RPA", "AI APIs"]
    },
    {
        id: 9,
        name: "AI Learning & Training Programs",
        icon: "🎓",
        category: "ai",
        description: "Comprehensive AI training programs for teams and organizations. High demand from companies seeking AI expertise and practical training on AI tools and applications.",
        details: [
            "AI Fundamentals for Business Professionals",
            "Advanced AI Development & Integration",
            "AI for Business Leaders & Executives",
            "Custom Corporate AI Training Programs",
            "Prompt Engineering Workshops",
            "Hands-on AI tool implementation"
        ],
        certifications: ["AI Training", "Prompt Engineering", "AI Integration"]
    },
    {
        id: 10,
        ...
        details: [
            "AI opportunity assessment and analysis",
        ...
        certifications: ["AI Strategy", "Business Consulting"]
    },
    {
        id: 11,
        ...
        icon: "📊",
        category: "ai",
        description: "Transform data into actionable insights using AI analytics tools. AI-enhanced reporting, data analysis, and decision-making support systems.",
        details: [
            "AI-powered data analytics and reporting",
            "Intelligent business intelligence dashboards",
            "AI-enhanced data visualization",
            "Automated report generation",
            "Predictive analytics using AI tools",
            "Data-driven decision support systems"
        ],
        technologies: ["AI Analytics", "Business Intelligence", "Data Visualization"]
    },
    {
        id: 5,
