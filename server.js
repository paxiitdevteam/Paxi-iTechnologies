...
function generateSitemap(req, res) {
    try {
        // GitHub Pages project site (flattened: /Paxi-iTechnologies/*.html)
        const baseUrl = (process.env.PUBLIC_SITE_URL || 'https://paxiitdevteam.github.io/Paxi-iTechnologies').replace(/\/$/, '');
